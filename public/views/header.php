...
<head>
    ...
    <?php
    // Only include Matomo if on contractwekker.nl
    $host = $_SERVER['HTTP_HOST'] ?? '';
    if (preg_match('/(^|\.)contractwekker\.nl$/i', $host)):
    ?>
    <!-- Matomo -->
    <script>
    ...
    (function() {
        var u="//contractwekker-stats.b-cdn.net/stats/";
        _paq.push(['setTrackerUrl', u+'matomo.php']);
        _paq.push(['setSiteId', 'n6j15xjoE7']);
